                    ...
                    <tr key={scoreLevel.id} className='border-b hover:bg-gray-100'>
                        ...
                        <td className='px-6 py-4'>
                            <Input
                                ...
                                onChange={(e) => handleLevelChange(scoreLevel.id, 'minScore', Math.min(10, Math.max(0, parseInt(e.target.value) || 0)))}
                                placeholder='0'
                        ...
                        <td className='px-6 py-4'>
                            <Input
                                ...
                                onChange={(e) => handleLevelChange(scoreLevel.id, 'maxScore', Math.min(10, Math.max(0, parseInt(e.target.value) || 0)))}
                                placeholder='0'
                                className='bg-white border border-gray-300 text-center text-base py-2'
                            />
                        </td>
